...
namespace ConsoleApp3
{
    public class Matan
    {
        ...
        public double MatRadTr(double a, double b, double c, double R)
        {
            return (a * b * c) / 4.0 * R;
        }
        ...
        public double MatPrTr(double a, double b)
        {
            return 1.0 / 2.0 * a * b;
        }
        ...
        public double MatOpOkr(double R)
        {
        ...
        public double MatStor(double a)
        {
